...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(self.id,temp,self.balance))
        self.id += 1
        return self.balance
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        temp = Mint.present_year - self.year 
        if self.cents:
            if temp > 50:
                return self.cents + temp - 50
            else:
                return self.cents
        else:
            if temp > 50:
                return Mint.present_year - self.year - 50
            else:
                return 0
